...
default['jenkins']['master'].tap do |master|
  ...
  #Project git URL
  master['project_git_url'] = 'https://github.com/spring-projects/spring-petclinic.git'
  # Build job name
  master['build_job_name'] = 'Build_Project'
  # Build job directory
  master['build_job_directory'] = "#{node['jenkins']['master']['home']}/jobs/#{node['jenkins']['master']['build_job_name']}"
